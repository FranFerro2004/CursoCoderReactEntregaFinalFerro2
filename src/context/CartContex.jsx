...
export const CartProvider = ({
    children}) => {
        ...
        const precioTotalCarrito = carrito.reduce((total, producto) => {
        ...
        return(
            <>
                <CartContext.Provider value={{agregarAlCarrito, carrito, eliminarDelCarrito, cantidadTotalProductos, precioTotalCarrito,}}>
                    {children}
